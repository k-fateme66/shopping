...
function Header() {
    return (
        <>
            <header className='py-9 border-b border-gray-100 top-0 fixed w-full z-[1] bg-transparent lg:transition-all lg:duration-500 lg:ease-in-out lg:hover:bg-white lg:hover:drop-shadow-md'>
